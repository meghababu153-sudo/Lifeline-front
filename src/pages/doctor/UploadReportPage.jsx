...
function UploadReportPage() {
  ...
  // Pre-fill patient ID from navigation state (e.g. "Upload" button on PatientSearchPage)
  useEffect(() => {
      ...
      <div className="p-10">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-500 mt-2">
            Upload a report on behalf of a patient. Your identity is recorded automatically.
          </p>
        </div>
        ...
        <div className="flex items-start gap-3 bg-blue-50 border border-blue-200 rounded-2xl p-5 mb-8">
          ...
          <div>
            ...
            <p className="text-blue-600 text-sm mt-1">
              This report will be recorded under your account with a server-side timestamp.
              No OTP is required — your JWT authenticates the upload.
            </p>
          </div>
        </div>
              ...
              {patientFound && (
                <div className="mt-4 flex items-center gap-4 bg-green-50 border border-green-200 rounded-2xl p-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-mono text-green-600">{patientFound.patient_code || patientFound.id}</p>
                  </div>
